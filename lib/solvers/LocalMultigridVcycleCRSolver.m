% LocalMultigridVcycleCRSolver (subclass of IterativeSolver) Solves linear
...
classdef LocalMultigridVcycleCRSolver < MultigridSolver
    %% methods
    methods
        function obj = LocalMultigridVcycleCRSolver(smoother)
    ...
    methods (Access=protected)
        ...
        function [Cx, algEstimator] = Vcycle(obj, x) 
            ...
            Cx = obj.smoother.average(Cx, L);
            updatedResidual = resAv{L} - obj.A * Cx;
