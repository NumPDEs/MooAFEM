...
classdef pLoc_MG < MGSolver
    ...
    methods (Access=public)
        ...
        function setup(obj, A, b, x0, P)
            ...
            mesh = P.fes.mesh;
            obj.P = P;
            polDeg = P.fes.finiteElement.order;

            %TO BE IMPROVED : later 1->p on the finest level in matrix form
            obj.feslow = FeSpace(P.fes.mesh, HigherOrderH1Fe(1), 'dirichlet', 'all');
            ...
            if (polDeg>1)
                ...
                dofs = assemblePatchDofs(P.fes,polDeg);
            ...
            setup@MGSolver(obj, A(freeDofs,freeDofs), b, x0);
        end
